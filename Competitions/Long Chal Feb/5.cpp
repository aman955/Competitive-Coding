...
struct number addi(number num1,number num2)
{
...
number temp;
temp.den=(num1.den*num2.den)%mod;
temp.num=((num1.num*num2.den)%mod+(num2.num*num1.den))%mod;
	return temp;
}
...
void multiply(number F[2][2],number M[2][2])
{
    ...
    temp1.num=(F[0][0].num*M[0][0].num)%mod;
    temp1.den=(F[0][0].den*M[0][0].den)%mod;
    temp2.num=(F[0][1].num*M[1][0].num)%mod;
    temp2.den=(F[0][1].den*M[1][0].den)%mod;
    x=add(temp1,temp2);
    
    temp1.num=(F[0][0].num*M[0][1].num)%mod;
    temp1.den=(F[0][0].den*M[0][1].den)%mod;
    temp2.num=(F[0][1].num*M[1][1].num)%mod;
    temp2.den=(F[0][1].den*M[1][1].den)%mod;
    y=add(temp1,temp2);
    
    temp1.num=(F[1][0].num*M[0][0].num)%mod;
    temp1.den=(F[1][0].den*M[0][0].den)%mod;
    temp2.num=(F[1][1].num*M[1][0].num)%mod;
    temp2.den=(F[1][1].den*M[1][0].den)%mod;
    z=add(temp1,temp2);
    
    temp1.num=(F[1][0].num*M[0][1].num)%mod;
    temp1.den=(F[1][0].den*M[0][1].den)%mod;
    temp2.num=(F[1][1].num*M[1][1].num)%mod;
    temp2.den=(F[1][1].den*M[1][1].den)%mod;
    w=add(temp1,temp2);
